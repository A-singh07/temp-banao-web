...
import { digitalMarkData } from '../../data/services'
...
const DigitalMarketing = () => {
  ...
  return (
    <>
      <Head>
        <title>Digital Marketing | Banao Technologies</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="description"
          content='Banao is most trusted Digital Marketing Agency in India.'
        />
        <meta name="keywords" content="Digital Marketing, Digital Marketing Company, Digital Marketing Agency, Digital Marketing Company in India"></meta>
      </Head>
      <Landing
        data={hero_data}
