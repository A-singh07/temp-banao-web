...
import { uxReviewData } from '../../data/services'
...
const Uxreview = () => {
  ...
  return (
    <>
      <Head>
        <title>UX Review | Banao Technologies</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="description"
          content='We build digital products that let people do things differently. See how our Product Design team can help you with an UX/ UI review of your product.'
        />
        <meta name="keywords" content="UX Review, UX Review Compnay, best ui/ux agency, ux Review company, ux studio , UX Review Compnay in India"></meta>
      </Head>
      <Landing
        data={hero_data}
