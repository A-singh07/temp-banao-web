...
import { androidData } from '../../data/services'
...
const Android = () => {
  ...
  return (
    <>
      <Head>
        <title>Android App Development | Banao Technologies</title>
        ...
        />
        <meta name="keywords" content="Android Development, Android App Development, Android App Development Company, Android App Development Company in India"></meta>
      </Head>
      ...
      <Section3 data={benefits_1_data}
        setShowModal={setShowModal}
      />
      <Section2 data={services_data}
        setShowModal={setShowModal} />
      <Section7 work_data={section7_2} />
      {/* <Section7 work_data={section7_3} /> */}
      <Section3 data={benefits_2_data}
        setShowModal={setShowModal}
      />
