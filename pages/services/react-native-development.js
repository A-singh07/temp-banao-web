...
import { reactnativeData } from '../../data/services'
...
const Reactnative = () => {
  ...
  return (
    <>
      <Head>
        <title>Hire ReactJS and React Native Developers in USA, UK, Dubai and India | Banao Technologies - Leading React Native App development company</title>
