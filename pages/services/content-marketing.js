...
import { contentMarkData } from '../../data/services'
...
const ContentMarketing = () => {
  ...
  return (
    <>
      <Head>
        <title>Content Marketing | Banao Technologies</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="description"
          content='Banao is most trusted Content Marketing Agency in India.'
        />
        <meta name="keywords" content="Content Marketing, Content Marketing Company, Content Marketing Agency, Content Marketing Company in India"></meta>
      </Head>
      <Landing
        data={hero_data}
