...
import { meanStackData } from '../../data/services'
...
const Meanstack = () => {
  ...
  return (
    <>
      <Head>
        <title>Hire NodeJS and AngularJS web developers in India | Banao Technologies - Top MEAN Web development company</title>
        ...
        />
        <meta name="keywords" content="MEAN Stack, MEAN Stack Development, MEAN Stack Development Company, MEAN Stack Development Company in India"></meta>
      </Head>
