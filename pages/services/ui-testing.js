...
import { uiTestingData } from '../../data/services'
...
const Uitesting = () => {
  ...
  return (
    <>
      <Head>
        <title>UI Testing | Banao Technologies</title>
        ...
        />
        <meta name="keywords" content="UI Testing, UI Testing Compnay, best ui/ux agency, UI Testing company, UI studio , UI Testing Compnay in India"></meta>
      </Head>
