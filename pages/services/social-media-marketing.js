...
import { socialMediaMarkData } from '../../data/services'
...
const SocialMediaMarketing = () => {
  ...
  return (
    <>
      <Head>
        <title>Social Media Marketing | Banao Technologies</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="description"
          content='Banao is most trusted Social Media Marketing Agency in India.'
        />
        <meta name="keywords" content="Social Media Marketing, Social Media Marketing Company, Social Media Marketing Agency, Social Media Marketing Company in India"></meta>
      </Head>
      <Landing
        data={hero_data}
