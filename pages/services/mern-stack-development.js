...
import { mernStackData } from '../../data/services'
...
const Mernstack = () => {
  ...
  return (
    <>
      <Head>
        <title>Hire NodeJS and ReactJS web developers in India | Banao Technologies - Top MERN Web development company</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="description"
          content='Banao is a leading MERN stack development company serving businesses in all industrial domains. Avail of our MERN Stack Development Services for best outcomes. '
        />
        <meta name="keywords" content="mern Stack, mern Stack Development, mern Stack Development Company, mern Stack Development Company in India"></meta>
      </Head>
