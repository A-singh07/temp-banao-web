...
import { qaData } from '../../data/services'
...
const Qualityassurance = () => {
  ...
  return (
    <>
      <Head>
        <title>Quality Assurance| Banao Technologies</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="description"
          content="Banao is an independent software testing company in India. Banao's quality assurance consulting services offer valuable and actionable insights to improve the quality of the software."
        />
        <meta name="keywords" content="Quality Assurance and Consulting, Quality Assurance and Consulting Company, Quality Assurance and Consulting Company in India"></meta>
      </Head>
