...
import { seleniumTestingData } from '../../data/services'
...
const Seleniumtesting = () => {
  ...
  return (
    <>
      <Head>
        <title>Selenium Testing | Banao Technologies</title>
        ...
        />
        <meta name="keywords" content="Selenium Testing, Selenium Testing Compnay, Selenium Testing company, Selenium Testing Compnay in India"></meta>
      </Head>
