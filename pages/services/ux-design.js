...
import { uxDesignData } from '../../data/services'
...
const Uxdesign = () => {
  ...
  return (
    <>
      <Head>
        <title>User Experience (UX) Design Agency in USA, UK, Dubai and India | Banao Technologies</title>
        ...
        />
        <meta name="keywords" content="UX Design, UX Design Compnay, best ui/ux agency, ux research company, ux studio , UX Design Compnay in India"></meta>
      </Head>
      <Landing
        data={hero_data}
