...
import { blockchainDevData } from '../../data/services'
...
const BlockchainDev = () => {
  ...
  return (
    <>
      <Head>
        <title>Hire Blockchain Developers in USA, UK, Dubai and India | Banao Technologies - Leading Blockchain  development company</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="description"
          content='Banao is an award-winning UI/UX Design studio. We are a team of dedicated individuals making the digital world better by our skills and passion for design.'
        />
        <meta name="keywords" content="Blockchain Development, Blockchain Development Company, Blockchain Development agency, Blockchain Development Compnay in India"></meta>
      </Head>
