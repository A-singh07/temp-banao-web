...
import { teleMarkData } from '../../data/services'
...
const TeleMarketing = () => {
  ...
  return (
    <>
      <Head>
        <title>TeleMarketing | Banao Technologies</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="description"
          content='Banao is most trusted TeleMarketing Agency in India.'
        />
        <meta name="keywords" content="TeleMarketing, TeleMarketing Company, TeleMarketing Agency, TeleMarketing Company in India"></meta>
      </Head>
      <Landing
        data={hero_data}
