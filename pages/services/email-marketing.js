...
import { emailMarkData } from '../../data/services'
...
const EmailMarketing = () => {
  ...
  return (
    <>
      <Head>
        <title>Email Marketing | Banao Technologies</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="description"
          content='Banao is most trusted Email Marketing Agency in India.'
        />
        <meta name="keywords" content="Email Marketing, Email Marketing Company, Email Marketing Agency, Email Marketing Company in India"></meta>
      </Head>
      <Landing
        data={hero_data}
