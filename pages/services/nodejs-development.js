...
import { nodeJsData } from '../../data/services'
...
const NodeJs = () => {
  ...
  return (
    <>
      <Head>
        <title>Hire NodeJS web developers in India | Banao Technologies - Top NodeJS Web development company</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="description"
          content='Banao is a leading Node Js development company serving businesses in all industrial domains. Avail of our MERN Stack Development Services for best outcomes. '
        />
        <meta name="keywords" content="NodeJs, Node Js, NodeJs Development, NodeJs Development Company, NodeJs Development Company in India"></meta>
      </Head>
