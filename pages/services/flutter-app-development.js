...
import { flutterData } from '../../data/services'
...
const Flutter = () => {
  ...
  return (
    <>
      <Head>
        <title>Flutter Development | Banao Technologies</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="description"
          content='Banao is most trusted Flutter App Development Company in India. Our team has experience in building world-class highly-sophisticated Flutter apps'
        />
        <meta name="keywords" content="Flutter Development, Flutter App Development, Flutter App Development Company, Flutter App Development Company in India"></meta>
      </Head>
      <Landing data={hero_data}
        setShowModal={setShowModal}
        home={true}
      />
      <Section7 work_data={section7} />
      <Section3 data={importance_data}
        setShowModal={setShowModal}
      />
