...
import { smsWhatsappMarkData } from '../../data/services'
...
const SmsWhatsappMarketing = () => {
  ...
  return (
    <>
      <Head>
        <title>SMS/WhatsApp Marketing | Banao Technologies</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="description"
          content='Banao is most trusted SMS/WhatsApp Marketing Agency in India.'
        />
        <meta name="keywords" content="SMS/WhatsApp Marketing, SMS/WhatsApp Marketing Company, SMS/WhatsApp Marketing Agency, SMS/WhatsApp Marketing Company in India"></meta>
      </Head>
      <Landing
        data={hero_data}
