...
import { graphicDesignData } from '../../data/services'
...
const Graphicdesign = () => {
  ...
  return (
    <>
      <Head>
        <title>Hire graphic designers online from Banao Technologies</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="description"
          content='Banao is an award-winning Graphic Design studio. We are a team of dedicated individuals making the digital world better by our skills and passion for design.'
        />
        <meta name="keywords" content="Graphic Design, Graphic Design Compnay, best ui/ux agency, Graphic Design studio , Graphic Design Compnay in India"></meta>
      </Head>
      <Landing
        data={hero_data}
