...
import { socialMediaAdvrtData } from '../../data/services'
...
const SocialMediaMarketing = () => {
  ...
  const {
    ...
    blogs_data,
    faq_data,
  } = socialMediaAdvrtData
  return (
    <>
      <Head>
        <title>Social Media Advertising | Banao Technologies</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="description"
          content='Banao is most trusted Social Media Advertising Agency in India.'
        />
        <meta name="keywords" content="Social Media Advertising, Social Media Advertising Company, Social Media Advertising Agency, Social Media Advertising Company in India"></meta>
      </Head>
      <Landing
        data={hero_data}
