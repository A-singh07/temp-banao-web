...
import { uiDesignData } from '../../data/services'
...
const Uidesign = () => {
  ...
  return (
    <>
      <Head>
        <title>User Interface (UI) Design agency in USA, UK, Dubai and India | Banao Technologies</title>
        ...
        />
        <meta name="keywords" content="UI Design, UI Design Compnay, best ui/ux agency, UI research company, UI studio , UI Design Compnay in India"></meta>
      </Head>
      <Landing
        data={hero_data}
