...
import { youthMarkData } from '../../data/services'
...
const YouthMarketing = () => {
  ...
  return (
    <>
      <Head>
        <title>Youth Marketing | Banao Technologies</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="description"
          content='Banao is most trusted Youth Marketing Agency in India.'
        />
        <meta name="keywords" content="Youth Marketing, Youth Marketing Company, Youth Marketing Agency, Youth Marketing Company in India"></meta>
      </Head>
      <Landing
        data={hero_data}
