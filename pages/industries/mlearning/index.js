...
import { healthcare } from "../../../data/industries-data";
...
function Index() {
  ...
  return (
    <>
      <Head>
        <title>mLearning Solutions| Banao Technologies</title>
        ...
        />
        <meta name="keywords" content="Health Care Solutions, Health Care Solutions Company, Health Care Solutions Company in India"></meta>
      </Head>
      <Landing data={hero}
      ...
      <Section2 data={section2}
        ...
        setShowModal={setShowModal}
      />
      <Section7 work_data={work_data_2} />
      <Section3 data={section3_1} reverse={section3_1.reverse}
        showModal={showModal}
        setShowModal={setShowModal}
      />
      <Section3 data={section3_2} reverse={section3_2.reverse}
        showModal={showModal}
        setShowModal={setShowModal}
      />
